// lib/screens/beneficiary_pickup_schedule_screen.dart
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

class BeneficiaryPickupScheduleScreen extends StatefulWidget {
  const BeneficiaryPickupScheduleScreen({super.key});

  @override
  State<BeneficiaryPickupScheduleScreen> createState() =>
      _BeneficiaryPickupScheduleScreenState();
}

class _BeneficiaryPickupScheduleScreenState
    extends State<BeneficiaryPickupScheduleScreen> {
  bool _busy = false;

// lib/screens/beneficiary_edit_pickup_details_screen.dart
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class BeneficiaryEditPickupDetailsScreen extends StatefulWidget {
  const BeneficiaryEditPickupDetailsScreen({super.key});

  @override
  State<BeneficiaryEditPickupDetailsScreen> createState() =>
      _BeneficiaryEditPickupDetailsScreenState();
}

class _BeneficiaryEditPickupDetailsScreenState
    extends State<BeneficiaryEditPickupDetailsScreen> {
  ...
  Future<void> _save({
    ...
    if (!isRecipient) {
      _snack('Only the accepted beneficiary can edit this pickup.');
      return;
    }

...
class CreatePickupDetailsScreen extends StatefulWidget {
  const CreatePickupDetailsScreen({super.key});

  @override
  State<CreatePickupDetailsScreen> createState() =>
      _CreatePickupDetailsScreenState();
}

class _CreatePickupDetailsScreenState extends State<CreatePickupDetailsScreen> {
                ...
                children: [
                  if (!isRecipient)
                    _warn(
                      ...
                      'Only the accepted food bank should schedule the pickup.',
                    ),
                  if (!isAccepted)
                    _warn(
  ...
  Future<void> _save({
    ...
    if (!isRecipient) {
      _snack('Only the accepted recipient can schedule this pickup.');
      return;
    }

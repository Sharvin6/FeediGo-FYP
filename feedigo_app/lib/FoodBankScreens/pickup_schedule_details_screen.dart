...
class PickupScheduleDetailsScreen extends StatefulWidget {
  const PickupScheduleDetailsScreen({super.key});

  @override
  State<PickupScheduleDetailsScreen> createState() =>
      _PickupScheduleDetailsScreenState();
}

class _PickupScheduleDetailsScreenState
    extends State<PickupScheduleDetailsScreen> {
            ...
            builder: (context, rSnap) {
              ...
              return ListView(
                ...
                children: [
                  ...
                  // --- NEW: View Proofs button for completed records (read-only) ---
                  if (status == 'completed') ...[
                    Align(
                      alignment: Alignment.centerRight,
